    ...
    if (answers[numberQuestion] === userAnswer) {
        ...
        setTimeout(() => {
            ...
            setTimeout(() => {
                ...
                console.log(blockQuestionParentElement.children, numberQuestion);
...
const answers = {
    ...
    question_5: 'Բ․ Րաֆֆի',
    question_6: 'Բ․ «Պեպո»',
    question_7: 'Դ․ Բիլ Գեյթս',
    question_8: 'Ա․ Ինդոնեզիա',
    question_9: 'Դ․ Կապույտ կետ',
    question_10: 'Ա․ Վեներա',
    question_11: 'Բ․ 27 օր',
    question_12: 'Բ. 6',
    question_13: 'Դ․ 71.12',
    question_14: 'Գ․ Կարմիր',
    question_15: 'Դ․ Բեթհովեն',
